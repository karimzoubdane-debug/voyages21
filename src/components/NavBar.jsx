...
// Cadran image + titre (image en haut, titre en bas)
function MenuCard({ item, onClose }) {
  if (!item.img) {
    return (
      <Link href={item.href} onClick={onClose} style={{ textDecoration: 'none', flexShrink: 0 }}>
        <div
          style={{
            width: '115px', height: '88px', borderRadius: '6px',
        ...
        >
          <span style={{ color: '#C8A440', fontSize: '0.68rem', fontWeight: 600, lineHeight: 1.35 }}>
            {item.label}
          </span>
        </div>
      </Link>
  ...
  return (
    <Link href={item.href} onClick={onClose}
      style={{ textDecoration: 'none', flexShrink: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.45rem', width: '115px' }}
    >
      <div
        style={{
          width: '110px', height: '88px', borderRadius: '6px',
      ...
      />
      <span style={{ color: 'rgba(255,255,255,0.88)', fontSize: '0.68rem', fontWeight: 500, textAlign: 'center', lineHeight: 1.3 }}>
        {item.label}
      </span>
    </Link>
  )
...
function RightCadran({ onClose }) {
  return (
    <Link
      ...
      onClick={onClose}
      style={{
        position: 'relative', width: '185px', flexShrink: 0, alignSelf: 'stretch',
        borderRadius: '8px', overflow: 'hidden', minHeight: '130px',
    ...
    >
      <div style={{
        ...
        background: 'linear-gradient(to top, rgba(35,48,18,0.95) 0%, rgba(35,48,18,0.45) 50%, rgba(35,48,18,0.05) 100%)',
      }} />
      <div style={{ position: 'relative', padding: '1.2rem', textAlign: 'center' }}>
        <p style={{ color: '#FFFFFF', fontSize: '0.82rem', fontWeight: 600, letterSpacing: '0.04em', lineHeight: 1.45, marginBottom: '0.3rem' }}>
          Voir tous<br />nos circuits
        </p>
        <span style={{ color: '#C8A440', fontSize: '1rem' }}>→</span>
      </div>
    </Link>
  )
}

// Label de section dans les mega menus
const SEC = {
...
export default function NavBar() {
  ...
  const [openMenu,   setOpenMenu]   = useState(null) // 'inspirations' | 'styles' | 'explorer'
  ...
  return (
    <>
      ...
      <header style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 1000, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{
          height: '68px',
          background: scrolled ? 'rgba(35,49,24,0.97)' : 'transparent',
          ...
          <a href="tel:+212661181618" style={{
            ...
            fontWeight: 500, letterSpacing: '0.04em', flexShrink: 0, marginRight: '1.2rem',
          ...
          <div className="bar3-menu" style={{ display: 'flex', alignItems: 'center', gap: '0.2rem', flex: 1, justifyContent: 'center' }}>
          ...
          <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', gap: '2rem', alignItems: 'stretch' }}>
            <div style={{ flex: 1 }}>
              ...
              <Link href="/about#styles" onClick={closeNow}
                style={{ color: '#C8A440', fontSize: '0.78rem', fontWeight: 600, textDecoration: 'none', letterSpacing: '0.04em', transition: 'opacity .15s' }}
                onMouseEnter={e => e.currentTarget.style.opacity = '0.7'}
                onMouseLeave={e => e.currentTarget.style.opacity = '1'}
              >
                A propos de nos styles de voyages →
              </Link>
            </div>
            <RightCadran onClose={closeNow} />
          </div>
        ...
        <div className="mobile-panel">
          <ul style={{ listStyle: 'none', padding: '1rem 1.5rem' }}>
            {[
              ...
              { label: 'A propos',                 href: '#',                               section: true },
