...
const OWNER_ONLY = new Set(['/admin-produits.html', '/admin-cover.html', '/admin-popup.html']);
...
export const config = {
  matcher: ['/admin-produits.html', '/admin-cover.html', '/admin-popup.html', '/admin-medias.html', '/formulaire-voyage.html'],
};
