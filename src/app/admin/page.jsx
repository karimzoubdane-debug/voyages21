...
const TOOLS = {
  ...
  popup: { href: '/admin-popup.html', icon: '📣', title: 'Popup / Offre du jour', desc: "Fenêtre promo de l'accueil (image ou reel)" },
};
...
export default function AdminPortal() {
  ...
  const tools = isOwner ? [TOOLS.produits, TOOLS.cover, TOOLS.popup, TOOLS.fiche, TOOLS.medias] : [TOOLS.fiche, TOOLS.medias];
