...
export const metadata = {
  title: 'Moto Expéditions — Voyages21',
  description: 'Raids moto au Maroc — BMW GS & KTM Adventure. Page en cours de construction.',
}

export default function MotoExpeditionsPage() {
  return (
    <main style={{ paddingTop: '100px', minHeight: '60vh', background: 'var(--light-gray)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center', padding: '4rem 2rem' }}>
        ...
        <h1 style={{ fontFamily: 'Playfair Display, serif', fontSize: '2.5rem', color: 'var(--navy)', marginBottom: '1rem' }}>Moto Expéditions</h1>
