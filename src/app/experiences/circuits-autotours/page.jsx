...
export const metadata = {
  title: 'Circuits & Autotours — Voyages21',
  description: 'Circuits classiques et autotours au Maroc. Page en cours de construction.',
}
  ...
  return (
    <main style={{ paddingTop: '100px', minHeight: '60vh', background: 'var(--light-gray)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center', padding: '4rem 2rem' }}>
        ...
        <h1 style={{ fontFamily: 'Playfair Display, serif', fontSize: '2.5rem', color: 'var(--navy)', marginBottom: '1rem' }}>Circuits & Autotours</h1>
