...
window.VOYAGES = {
  ...
  "omra-mouharram": {
    ...
    priceTable: {
      ...
      columns: ["ثنائية", "ثلاثية", "رباعية"],
      currency: "درهم",
      rows: [
        { medinaHotel: { name: "إعمار طيبة" }, meccaHotel: { name: "إعمار الديوان" }, prices: ["18 900", "17 800", "17 200"] },
        { medinaHotel: { name: "إعمار طيبة" }, meccaHotel: { name: "إعمار الخليل" }, prices: ["20 200", "18 750", "—"] },
        { medinaHotel: { name: "إعمار طيبة" }, meccaHotel: { name: "إعمار المنار" }, prices: ["21 000", "19 600", "18 800"] },
        { medinaHotel: { name: "إعمار إليت" }, meccaHotel: { name: "إعمار جراند" }, prices: ["22 800", "20 950", "20 000"] },
        { medinaHotel: { name: "إعمار رويال" }, meccaHotel: { name: "إعمار الشهداء" }, prices: ["25 800", "23 800", "22 800"] }
      ],
  ...
  "omra-06-juillet": {
    ...
    priceTable: {
      ...
      currency: "درهم",
      rows: [
        { medinaHotel: { name: "فندق شذا ريجنسي" }, meccaHotel: { name: "أجياد مكة مكارم" }, prices: ["24 500", "22 500", "21 500"] },
        { medinaHotel: { name: "فندق شذا ريجنسي" }, meccaHotel: { name: "سويس مكة / الحرم" }, prices: ["29 500", "26 500", "24 900"] },
        { medinaHotel: { name: "فندق شذا ريجنسي" }, meccaHotel: { name: "الفيرمونت" }, prices: ["30 500", "27 500", "25 900"] }
      ],
      note: "الأسعار بالدرهم المغربي للفرد بالغرفة."
    },
  ...
  "omra-09-septembre-ram": {
    ...
    hotels: [
      ...
      "مكة المكرمة: موطن سنود (بدون إفطار) · ضيافة الرجاء (بالإفطار) · الشهداء أو أنجم مكة (بالإفطار) — حسب الفئة"
    ],
    priceTable: {
      style: "hotel-grid",
      medina: { label: "المدينة المنورة" },
      ...
      rows: [
        {
          ...
          meccaHotel: { name: "موطن سنود", key: "hotel-mk-watan-lamar" },
          prices: ["15 600", "14 900", "14 500", "13 700"]
        },
        {
          ...
          prices: ["20 500", "18 500", "17 500", "—"]
        },
        {
          medinaHotel: { name: "ميسان الحارثية", key: "hotel-md-maysan-harithiya" },
          meccaHotel: { name: "الشهداء أو أنجم مكة", key: "hotel-mk-shuhada" },
          prices: ["23 800", "21 500", "20 500", "—"]
        }
      ],
  ...
  "omra-08-juillet": {
    ...
    priceTable: {
      ...
      currency: "درهم",
      rows: [
        { medinaHotel: { name: "إعمار طيبة" }, meccaHotel: { name: "إعمار الديوان" }, prices: ["18 200", "17 300", "16 850"] },
        { medinaHotel: { name: "إعمار طيبة" }, meccaHotel: { name: "إعمار الخليل" }, prices: ["19 000", "17 900", "—"] },
        { medinaHotel: { name: "إعمار طيبة" }, meccaHotel: { name: "إعمار المنار" }, prices: ["19 500", "18 400", "17 800"] },
        { medinaHotel: { name: "إعمار طيبة" }, meccaHotel: { name: "إعمار البيت / جراند" }, prices: ["21 000", "19 700", "19 000"] },
        { medinaHotel: { name: "إعمار طيبة" }, meccaHotel: { name: "إعمار رويال / الشهداء" }, prices: ["23 500", "21 900", "21 000"] }
      ],
      note: "الأسعار بالدرهم المغربي للفرد بالغرفة."
    },
  ...
  "omra-istanbul": {
    ...
    priceTable: {
      ...
      currency: "درهم",
      rows: [
        { medinaHotel: { name: "إعمار طيبة" }, meccaHotel: { name: "إعمار الخليل" }, prices: ["21 500", "—", "20 000"] },
        { medinaHotel: { name: "إعمار طيبة" }, meccaHotel: { name: "إعمار المنار" }, prices: ["22 000", "20 600", "20 300"] },
        { medinaHotel: { name: "إعمار طيبة" }, meccaHotel: { name: "إعمار البيت / جراند" }, prices: ["23 500", "22 000", "21 500"] },
        { medinaHotel: { name: "إعمار طيبة" }, meccaHotel: { name: "إعمار رويال / الشهداء" }, prices: ["25 500", "23 600", "23 000"] }
      ],
      note: "الأسعار بالدرهم المغربي للفرد بالغرفة."
    },
  ...
  "omra-27-juillet-etihad": {
    ...
    priceTable: {
      ...
      currency: "درهم",
      rows: [
        { medinaHotel: { name: "ديار الإيمان" }, meccaHotel: { name: "روابي الحجاز" }, prices: ["15 500", "14 500", "12 900"] },
        { medinaHotel: { name: "ديار الإيمان" }, meccaHotel: { name: "فندق فلسطين" }, prices: ["17 900", "15 900", "14 900"] },
        { medinaHotel: { name: "ديار الإيمان" }, meccaHotel: { name: "ضيافة الرجاء" }, prices: ["18 900", "16 900", "15 900"] }
      ],
      note: "الأسعار بالدرهم المغربي للفرد بالغرفة."
    },
  ...
  "omra-01-juillet": {
    ...
    priceTable: {
      ...
      currency: "درهم",
      rows: [
        { medinaHotel: { name: "مجموعة المختارة" }, meccaHotel: { name: "فلسطين" }, prices: ["17 900", "16 700", "15 900"] },
        { medinaHotel: { name: "ديار الإيمان" }, meccaHotel: { name: "ضيافة الرجاء" }, prices: ["19 900", "18 700", "17 900"] }
      ],
      note: "الأسعار بالدرهم المغربي للفرد بالغرفة."
    },
