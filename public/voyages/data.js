...
window.VOYAGES = {
  ...
  "omra-09-septembre-ram": {
    ...
    exclus: [],
    hotels: [
      "المدينة المنورة: كراند بلازا المدينة أو موطن لمار (بدون إفطار)",
      "مكة المكرمة: كراند بلازا بدر المقام أو ضيافة الرجاء (بالإفطار) — أو ميسان الحارثية أو الشهداء (بالإفطار)"
    ],
    priceTable: {
      head: ["الفندق", "خماسية", "رباعية", "ثلاثية", "ثنائية"],
      rows: [
        ["كراند بلازا المدينة / موطن لمار<span class=\"pt-city\">المدينة المنورة</span>", "14 900", "15 700", "16 000", "16 800"],
        ["كراند بلازا بدر المقام / ضيافة الرجاء<span class=\"pt-city\">مكة المكرمة</span>", "—", "18 500", "19 500", "21 500"],
        ["ميسان الحارثية / الشهداء<span class=\"pt-city\">مكة المكرمة</span>", "—", "21 600", "22 800", "25 500"]
      ],
  ...
  "omra-24-septembre-saudia": {
    ...
    priceTable: {
      head: ["الفندق", "خماسية", "رباعية", "ثلاثية", "ثنائية"],
      rows: [
        ["كراند بلازا المدينة / موطن لمار<span class=\"pt-city\">المدينة المنورة</span>", "13 500", "14 000", "14 500", "15 000"],
        ["كراند بلازا بدر المقام / ضيافة الرجاء<span class=\"pt-city\">مكة المكرمة</span>", "—", "16 000", "16 800", "18 200"],
        ["ميسان الحارثية / الشهداء<span class=\"pt-city\">مكة المكرمة</span>", "—", "17 900", "19 000", "20 900"]
      ],
      note: "الأسعار بالدرهم المغربي للفرد بالغرفة. المدينة المنورة بدون إفطار، مكة المكرمة بالإفطار."
    },
    route: ["الدار البيضاء", "المدينة المنورة", "مكة المكرمة", "الدار البيضاء"],
