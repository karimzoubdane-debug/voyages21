...
window.VOYAGES = {
  ...
  "omra-09-septembre-ram": {
    ...
    priceTable: {
      ...
      rows: [
        ["كراند بلازا المدينة / موطن لمار (بدون إفطار) — المدينة المنورة", "14 900", "15 700", "16 000", "16 800"],
        ["كراند بلازا بدر المقام / ضيافة الرجاء (بالإفطار) — مكة المكرمة", "—", "18 500", "19 500", "21 500"],
        ["ميسان الحارثية / الشهداء (بالإفطار) — مكة المكرمة", "—", "21 600", "22 800", "25 500"]
      ],
  ...
  "omra-24-septembre-saudia": {
    ...
    priceTable: {
      head: ["الفندق", "خماسية", "رباعية", "ثلاثية", "ثنائية"],
      rows: [
        ["كراند بلازا المدينة / موطن لمار (بدون إفطار) — المدينة المنورة", "13 500", "14 000", "14 500", "15 000"],
        ["كراند بلازا بدر المقام / ضيافة الرجاء (بالإفطار) — مكة المكرمة", "—", "16 000", "16 800", "18 200"],
        ["ميسان الحارثية / الشهداء (بالإفطار) — مكة المكرمة", "—", "17 900", "19 000", "20 900"]
      ],
      note: "الأسعار بالدرهم المغربي للفرد بالغرفة."
    },
    route: ["الدار البيضاء", "المدينة المنورة", "مكة المكرمة", "الدار البيضاء"],
