...
window.VOYAGES = {
  ...
  "omra-mouharram": {
    ...
    priceTable: {
      head: ["فنادق المدينة المنوّرة", "فنادق مكة المكرّمة", "ثنائية", "ثلاثية", "رباعية"],
      rows: [
        ["إعمار طيبة — بدون إفطار", "إعمار الديوان — بدون إفطار", "18 900", "17 800", "17 200"],
        ["إعمار طيبة — بدون إفطار", "إعمار الخليل — بدون إفطار", "20 200", "18 750", "—"],
        ["إعمار طيبة — بدون إفطار", "إعمار المنار — إفطار", "21 000", "19 600", "18 800"],
        ["إعمار إليت — إفطار", "إعمار جراند — إفطار", "22 800", "20 950", "20 000"],
        ["إعمار رويال — إفطار", "إعمار الشهداء — إفطار", "25 800", "23 800", "22 800"]
      ]
    },
  ...
  "omra-06-juillet": {
    ...
    priceTable: {
      head: ["فندق مكة", "ثنائية", "ثلاثية", "رباعية"],
      rows: [
        ["أجياد مكة مكارم أو ما يعادله", "24 500", "22 500", "21 500"],
        ["سويس مكة / الحرم", "29 500", "26 500", "24 900"],
        ["الفيرمونت أو ما يعادله", "30 500", "27 500", "25 900"]
      ]
    },
  ...
  "omra-08-juillet": {
    ...
    priceTable: {
      head: ["فندق مكة", "ثنائية", "ثلاثية", "رباعية"],
      rows: [
        ["إعمار الديوان (بدون إفطار)", "18 200", "17 300", "16 850"],
        ["إعمار الخليل (بدون إفطار)", "19 000", "17 900", "—"],
        ["إعمار المنار (بدون إفطار)", "19 500", "18 400", "17 800"],
        ["إعمار البيت / جراند (بالإفطار)", "21 000", "19 700", "19 000"],
        ["إعمار رويال / الشهداء (بالإفطار)", "23 500", "21 900", "21 000"]
      ]
    },
  ...
  "omra-istanbul": {
    ...
    priceTable: {
      head: ["فندق مكة", "ثنائية", "ثلاثية", "رباعية"],
      rows: [
        ["إعمار الخليل", "21 500", "", "20 000"],
        ["إعمار المنار", "22 000", "20 600", "20 300"],
        ["إعمار البيت / جراند", "23 500", "22 000", "21 500"],
        ["إعمار رويال / الشهداء", "25 500", "23 600", "23 000"]
      ]
    },
  ...
  "omra-01-juillet": {
    ...
    priceTable: {
      head: ["الصيغة", "ثنائية", "ثلاثية", "رباعية"],
      rows: [
        ["فلسطين (بدون وجبات)", "17 900", "16 700", "15 900"],
        ["ضيافة الرجاء (بالإفطار)", "19 900", "18 700", "17 900"]
      ]
    },
