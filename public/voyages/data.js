...
window.VOYAGES = {
  ...
  "omra-mouharram": {
    ...
    priceTable: {
      head: ["الصيغة", "سعر الفرد"],
      rows: [
        ["ابتداءً من (غرفة رباعية)", "17 200 درهم"],
        ["إلى (غرفة ثنائية، فندق راقٍ)", "25 800 درهم"]
      ]
    },
  ...
  "omra-06-juillet": {
    ...
    dates: {
      ...
      note: "بخصوص الفنادق 5 نجوم، الغرف الثلاثية والرباعية بأسرّة إضافية. جواز سفر صالح لمدة لا تقل عن 8 أشهر قبل السفر. الأسعار قابلة للتغيير حسب الطيران. (الأسعار منقولة من الكتيّب، يُرجى التأكيد.)"
    },
  ...
  "omra-08-juillet": {
    ...
    dates: {
      ...
      note: "مع إمكانية حجز فنادق أخرى حسب الطلب. الأسعار قابلة للتغيير حسب الطيران. (الأسعار منقولة من الكتيّب، يُرجى التأكيد.)"
    },
    cta: { title: "هل تنوون أداء العمرة؟", text: "ننظّم رحلتكم على المقاس وفق تواريخكم ورغباتكم — Voyages 21، منذ سنة 2000." }
  },
