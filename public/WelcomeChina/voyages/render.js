...
(function () {
    ...
    app.innerHTML =
        '<div class="topbar"><div class="topbar-inner"><a href="/WelcomeChina/">' + L.back + '</a><span class="brand">WelcomeChina</span></div></div>'
        + '<div class="page">'
        ...
        + '<div class="wechat-modal" id="wechatModal" onclick="if(event.target===this)closeWechat()"><div class="wechat-box"><button class="wechat-close" onclick="closeWechat()">×</button><h3>WeChat</h3><p>Scan this QR code to contact Voyages 21.</p><img src="/WelcomeChina/assets/wechat-qr.jpeg" alt="Voyages 21 WeChat QR code"></div></div>'
