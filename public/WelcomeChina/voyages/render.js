...
(function () {
    ...
    app.innerHTML =
        '<div class="topbar"><div class="topbar-inner"><a href="/WelcomeChina/">' + L.back + '</a><span class="brand">WelcomeChina</span><div class="lang-switch" role="group" aria-label="Language"><button class="lang-btn' + (currentLang === "en" ? " active" : "") + '" onclick="setVoyageLang(\'en\')">English</button><button class="lang-btn' + (currentLang === "zh" ? " active" : "") + '" onclick="setVoyageLang(\'zh\')">中文</button></div></div></div>'
        + '<div class="page">'
